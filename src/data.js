...
export const UNIT_TYPES = {
  hero: {
    ...
    moraleBase: 100, mass: 1.4, radius: 10,
  ...
  levy: {
    ...
    hp: 55, armor: 0, speed: 62, meleeDmg: 12, meleeRate: 1.1, range: 0,
    moraleBase: 48, mass: 1, radius: 9,
  ...
  spearman: {
    ...
    hp: 72, armor: 1, speed: 58, meleeDmg: 15, meleeRate: 1.1, range: 0,
    moraleBase: 60, mass: 1.05, radius: 9, vsCavalry: 2.4,
    cost: { crowns: 28, provisions: 3 }, desc: 'Braced spears punish mounted charges.',
  },
  shieldman: {
    name: 'Shieldman', role: 'Durable frontline',
    hp: 98, armor: 3, speed: 50, meleeDmg: 12, meleeRate: 1.2, range: 0,
    moraleBase: 70, mass: 1.25, radius: 10, shieldBlock: 0.62,
  ...
  bowman: {
    ...
    range: 265, rangedDmg: 14, reload: 2.3, projSpeed: 260, projArc: 1,
    moraleBase: 50, mass: 0.95, radius: 9,
  ...
  pressurebow: {
    ...
    moraleBase: 58, mass: 1.05, radius: 9, industrial: true, steamShot: true,
  ...
  rider: {
    ...
    hp: 82, armor: 1, speed: 122, meleeDmg: 15, meleeRate: 1.0, range: 0,
    moraleBase: 60, mass: 1.6, radius: 12, cavalry: true, chargeDmg: 22,
  ...
  boilerlancer: {
    ...
    hp: 135, armor: 3, speed: 104, meleeDmg: 18, meleeRate: 1.15, range: 0,
    moraleBase: 75, mass: 2.2, radius: 13, cavalry: true, chargeDmg: 50, industrial: true,
